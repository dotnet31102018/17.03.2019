...
namespace _1703HW
{
    ...
    public class MyProtectedUniqueList : IEnumerable<string>
    {
        ...
        public void Add(string item)
        {
            if (item == null || item == string.Empty)
            {
                ...
                throw new StringEmptyException("string is empty/null", item);
            }

            if (words.Contains(item))
                throw new StringAlreadyExistException($"{item} already exists!");
        ...
        public bool Get(string item)
        {
            return this.words.Contains(item);
        }
